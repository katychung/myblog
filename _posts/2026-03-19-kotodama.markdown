...
*Edit: since this first project, I've been actively building with Claude — a React app, hosted on Vercel, using the Claude API and Google Places API. Each project teaches me something new about what's actually possible when the barrier to building is this low.*
